...
def t60_decay(t, decay, fsample, rt='t30'):
    """
    ...
    #Linear regression
    zerodecay = np.where(decay == 0)[0][0] #index at which the normalised spl is zero
    rt_decay = decay[zerodecay:] #decay of spl removing all the part before the zerodecay
