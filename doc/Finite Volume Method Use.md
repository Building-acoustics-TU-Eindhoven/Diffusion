...
9. Click "Add tetgen boundary to selected" ![Add tetgen boundary to selected](images/addtetgenboundary.png);
10. Under "Refine", change the refinement to 1;
11. Under "Name": change the name to "materialname" e.g."carpet" and click "ok";
12. After finishing defining all the boundaries, select the group and click "export to generate mesh" ![export to generate mesh](images/export.png);
