...
def run_fvm_sim(inputs, abs_coeff_path):
    ...
    Args:
        ...
        abs_coeff_path : str
            csv file of the absorption coefficient inputs
    ...
    #return (coord_source, coord_rec, fc_low, fc_high, num_octave, dt, m_atm, th, 
    #        file_name, center_freq, nBands, vGroupsNames, tcalc, df_abs, c0, Ws,
    #        pRef , rho,  dim, tag, nodecoords, node_indices, bounEl, bounNode, 
    #        voluEl, voluNode, belemNodes, velemNodes, boundaryEl_dict, volumeEl_dict, 
    #        cell_center, cell_volume, barea_dict, centre_area, fxt, txt, 
    #        neighbourVolume, interior_tet, interior_tet_sum, surface_absorption, 
    #        triangle_face_absorption, absorption_coefficient_dict, surface_areas, 
    #        boundary_areas, total_boundArea, V, S ,Eq_A, sourceon_time, 
    #        recording_time, t, recording_steps, Dx, Dy, Dz, dist_sr, cl_tet_s_keys, 
    #        total_weights_s, Vs, source1, sourceon_steps, s, cl_tet_r_keys, total_weights_r,
    #        room_length, room_width, room_height, x_axis, y_axis, line_rec_x_idx_list, 
    #        dist_x, line_rec_y_idx_list, dist_y, beta_zero_freq, w_new_band, 
    #        w_rec_band, w_rec_off_band, w_rec_off_deriv_band, p_rec_off_deriv_band, 
    #        idx_w_rec, t_off, w_rec_x_band, w_rec_y_band, spl_stat_x_band, 
    #        spl_stat_y_band, spl_r_band, spl_r_off_band, spl_r_norm_band, 
    #        sch_db_band, t30_band, edt_band, c80_band, d50_band, ts_band )
...
if __name__ == "__main__":
    ...
    results = run_fvm_sim(inputs,'absorption_coefficients.csv')
    
    # Save results explicitly
    #with open('resultsFVM.pkl', 'wb') as f:
