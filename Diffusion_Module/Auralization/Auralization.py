...
import pickle
import os
from Diffusion_Module.Auralization.Auralizationfunctions import *

def run_auralization_sim(anechoic_signal,resultsFVM):
    """
    ...
    ----------
        ...
        resultsFVM : dict
            Results from the FVM simulation
    ...
    """
    #print("Inside function, type:", type(resultsFVM))
    ...
    data_signal, fs = extract_anechoic(anechoic_signal)
...
if __name__ == "__main__":
    FVM_path = os.path.join(parent_path, 'FiniteVolumeMethod')
    anechoic_signal_path = os.path.join(script_dir, 'anechoic_signals')
    ...
    results = run_auralization_sim(anechoic_signal,resultsFVM)
